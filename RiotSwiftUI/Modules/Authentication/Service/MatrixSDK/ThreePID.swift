...
#warning("Could become an MXJSONModel")
...
struct ThreePIDValidationCodeBody: Codable {
    ...
    func dictionary() throws -> [AnyHashable: Any] {
        ...
        guard let dictionary = try JSONSerialization.jsonObject(with: jsonData) as? [AnyHashable: Any] else {
            throw CodableError.dictionaryError
        }
